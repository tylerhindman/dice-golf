    ...
    void Update()
    {
        ...
        if (Input.GetMouseButton(0)) {
            ...
            if (x != 0 || y != 0) {
                ...
                var mouseAngle = Mathf.Rad2Deg * Mathf.Atan2(mouseDiff.normalized.y, mouseDiff.normalized.x);
                ...
                var lineLength =
                    Mathf.Clamp((Mathf.Sign(mouseAngle) * mouseDiff.magnitude * this.lineMouseSlingshotScale) + this.lineRenderer.GetPosition(1).z, -this.lineMaxLength, this.lineRenderer.GetPosition(1).z);
